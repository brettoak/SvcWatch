...
type TimeSeriesRequest struct {
	...
	Interval  string   `form:"interval" binding:"omitempty,oneof=1m 5m 1h 6h 1d 1w 1M"`
	StartTime string   `form:"start_time" binding:"required"`
	EndTime   string   `form:"end_time" binding:"required"`
...
// @Param interval query string false "Aggregation interval (optional, automatically calculated if omitted)" Enums(1m, 5m, 1h, 6h, 1d, 1w, 1M)
// @Param start_time query string true "Start Time" default(2026-03-19 00:00:00)
// @Param end_time query string true "End Time" default(2026-03-20 00:00:00)
