...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 10,
                        "description": "Number of top paths to return (default 10, max 100)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/sev/stats/top-user-agents": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 10,
                        "description": "Number of top User-Agents to return (default 10, max 100)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controller.TopUserAgentsResponseWrapper"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "controller.TopUserAgentsResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/storage.TopUserAgentItem"
                    }
                },
                "message": {
                    "type": "string",
